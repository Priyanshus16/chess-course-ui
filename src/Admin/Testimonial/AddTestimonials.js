...
//   InputAdornment,
// } from "@mui/material";
// import { Person, EmojiEvents, Description, School, CloudUpload } from "@mui/icons-material";
...
//       if (!finalData.name || !finalData.achievement || !finalData.course || !finalData.description || !finalData.image) {
...
//               sx={{ backgroundColor: "#1976d2", color: "#fff", fontWeight: "bold", "&:hover": { backgroundColor: "#1565c0" } }}
//             >
//               Upload Image
...
import {
  ...
  BtnUndo,
  BtnRedo,
} from "react-simple-wysiwyg"; // Import Editor and EditorProvider
