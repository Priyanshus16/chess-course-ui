...
import { School, Description, Timelapse, MonetizationOn, CloudUpload } from "@mui/icons-material";
...
const AddCourses = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!finalData.title || !finalData.duration || !finalData.price || !finalData.description) {
        return Swal.fire("Please provide all fields.");
      }

      await axios.post(`${process.env.REACT_APP_BASE_ADMIN_URL}/addCourses`, finalData);
      ...
      <Container maxWidth="sm">
        ...
        >
          ...
          <form>
            ...
            {/* Description */}
            <Box sx={{ mt: 2, mb: 2 }}>
              <Typography variant="body1" sx={{ textAlign: "left", mb: 1, color: "#1E3A8A" }}>
                Description
              </Typography>
              <Toolbar>
                <BtnUndo />
