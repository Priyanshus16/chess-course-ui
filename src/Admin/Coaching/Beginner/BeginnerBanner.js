...
//         `${process.env.REACT_APP_BASE_ADMIN_URL}/beginnerBanner`,
//       );
//       setApiData(response.data.beginnerBanner); 
//     } catch (error) {
...
//     try {
//       await axios.put(
//         `${process.env.REACT_APP_BASE_ADMIN_URL}/beginnerBanner/${id}`,
//         editedData
//       );
//       setApiData((prevData) =>
//         prevData.map((item) =>
...
//           }}
//         >
//           Beginner Banner Management
//         </Typography>
//         <Button
//           variant="contained"
//           color="primary"
//           startIcon={<AddIcon />}
//           onClick={() => navigate("/admin/addbeginnerBanner")}
...
export default function BeginnerBanner() {
  ...
  const getData = async () => {
    try {
      const response = await axios.get(`${process.env.REACT_APP_BASE_ADMIN_URL}/beginnerBanner`);
      setApiData(response.data.beginnerBanner || []);
    } catch (error) {
      console.error("Error fetching data:", error);
    }
  ...
  const handleSave = async (id) => {
    try {
      await axios.put(`${process.env.REACT_APP_BASE_ADMIN_URL}/beginnerBanner/${id}`, editedData);
      setApiData((prevData) =>
  ...
  const handleUserDelete = async (id) => {
    ...
    if (result.isConfirmed) {
      try {
        await axios.delete(`${process.env.REACT_APP_BASE_ADMIN_URL}/beginnerBanner/${id}`);
        setApiData((prevData) => prevData.filter((item) => item._id !== id));
        Swal.fire("Deleted!", "Your beginner banner has been deleted.", "success");
      } catch (error) {
        console.error("Error deleting banner:", error);
