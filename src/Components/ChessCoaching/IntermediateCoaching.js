...
const coachingCards = [
    { icon: "♜", title: "Opening Mastery", description: "Deep understanding of opening principles and best responses." },
    { icon: "♞", title: "Tactical Vision", description: "Identify tactics like forks, pins, skewers, and discovered attacks." },
    { icon: "♛", title: "Time Management", description: "Learn to control the clock and optimize moves in time trouble." },
    { icon: "♗", title: "Transition to Endgames", description: "Understand when to simplify the position for a better endgame." },
];
